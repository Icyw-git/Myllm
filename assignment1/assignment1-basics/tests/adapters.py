...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.linear import multihead_self_attention
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    from cs336_basics.linear import multihead_self_attention_with_rope
...
def run_transformer_block(
    ...
    """
    from cs336_basics.linear import transformer_block
...
def run_transformer_lm(
    ...
    """
    from cs336_basics.linear import transformer_lm
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.linear import silu
...
def run_get_batch(
    ...
    """
    from cs336_basics.linear import get_batch
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.linear import gradient_clipping
...
def get_adamw_cls() -> Any:
    ...
    """
    from cs336_basics.linear import get_adamw_cls
    return get_adamw_cls()
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.linear import get_lr_cosine_schedule
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.linear import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.linear import load_checkpoint
